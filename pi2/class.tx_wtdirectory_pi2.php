...
class tx_wtdirectory_pi2 extends tslib_pibase {
	...
	function drillDown() {
		...
		$templateCode = tslib_CObj::getSubpart(tsLib_CObj::fileResource($filePath),'###WTDIRECTORY_FILTER_DRILLDOWN###');
		$this->content .= tslib_cObj::substituteMarkerArray($templateCode, $markerArray);
